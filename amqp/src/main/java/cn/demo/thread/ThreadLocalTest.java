...
public class ThreadLocalTest {
        ...
        for (int i = 0; i < 2; i++) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    x.set(data);
                    /*
                     * MyThreadScopeData myData = new MyThreadScopeData(); myData.setName("name" +
                     * data); myData.setAge(data); myThreadScopeData.set(myData);
                     */
    ...
    static class A {
        public void get() {
            ...
            /*
             * MyThreadScopeData myData = myThreadScopeData.get();; System.out.println("A from " +
